    ...
    public class Projectile_Fire : Projectile_Anim
    {
        ...
        */
        ...
        protected override void DrawAt(Vector3 drawLoc, bool flip = false)
        {
            ...
            Mesh mesh2 = MeshPool.GridPlane(DefDatabase<ThingDef>.GetNamed("Mote_FireGlow").graphicData.drawSize * (traveled * 7));
            Graphics.DrawMesh(mesh, this.DrawPos, this.ExactRotation, Graphic.MatSingle, 0);
            Graphics.DrawMesh(mesh2, this.DrawPos, this.ExactRotation, DefDatabase<ThingDef>.GetNamed("Mote_FireGlow").graphic.MatSingle, 0);
            base.Comps_PostDraw();
        }
