...
namespace RimWorld
{
    ...
    public class JobGiver_Neomorph_Flee : ThinkNode_JobGiver
    {
        ...
        private Job FleeJob(Pawn pawn, Thing danger)
        {
            ...
            {
                JobGiver_Neomorph_Flee.tmpThings.Clear();
                JobGiver_Neomorph_Flee.tmpThings.Add(danger);
                intVec = CellFinderLoose.GetFleeDest(pawn, JobGiver_Neomorph_Flee.tmpThings, 30f);
                JobGiver_Neomorph_Flee.tmpThings.Clear();
            }
